...
signals:
    ...
    void sendStoredComment(guint32 frame, QString comment);
...
public slots:
    ...
    void copyCurrentPacketComment(QString comment);
    void pasteStoredComment(guint32 frame);
    void handlePCDRejectSignal(guint32 frame, bool deleteComment);
    void handlePCDAcceptSignal(guint32 frame, QString comment);
